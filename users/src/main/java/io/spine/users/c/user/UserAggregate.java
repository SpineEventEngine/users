...
import io.spine.users.c.user.AuthIdentityAdded;
import io.spine.users.c.user.AuthIdentityRemoved;
...
import io.spine.users.c.user.PrimaryAuthIdentityChanged;
...
import io.spine.users.c.user.UserAttributeAdded;
import io.spine.users.c.user.UserAttributeRemoved;
import io.spine.users.c.user.UserAttributeUpdated;
import io.spine.users.c.user.UserCreated;
import io.spine.users.c.user.UserDeleted;
import io.spine.users.c.user.UserJoinedGroup;
import io.spine.users.c.user.UserLeftGroup;
import io.spine.users.c.user.UserMoved;
import io.spine.users.c.user.UserSignedIn;
import io.spine.users.c.user.UserSignedOut;
import io.spine.users.c.user.UserStatusChanged;
